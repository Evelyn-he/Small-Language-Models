...
def get_user_with_orders(user_id, redact=True):
    ...
    """, (user_id,))
    orders = [{"TrackingNumber": no, "StockCode": s, "PurchasedItemDescription": d, "Quantity": q, "PurchaseDate": date, "UnitPrice": u, "Country": c} for no, s, d, q, date, u, c in cur.fetchall()]
