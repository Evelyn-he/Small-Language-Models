...
class FAQRetriever:
    ...
    def _vector_search_faq(self, embedded_query, top_k: int=3):
    ...
    def _format(self, lst: List[Dict[str, Any]]) -> str:
        ...
        lines = []
        lines.append("Relevant Business Information:")
    ...
    def search(self, embedded_query, top_k=3):
        top_orders = self._vector_search_faq(embedded_query=embedded_query)
